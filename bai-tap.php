                ...
                <div class="info-item">
                    ...
                    <div class="exercise-list">
                        <div class="exercise-group w100">
                            <p class="exercise-title">PHP & FORM</p>
                            <ul class="exercise-item ">
                                <li> <a href="./bai-tap/le-thi-thu-phuong-form/BT1_FAF.php">Exercise 1</a> </li>
                                <li> <a href="./bai-tap/le-thi-thu-phuong-form/BT2_FAF.php">Exercise 2</a> </li>
                        ...
                        <div class="exercise-group w100">
                            <p class="exercise-title">MẢNG, CHUỖI & HÀM</p>
                            <ul class="exercise-item">
                                <li> <a href="./bai-tap/le-thi-thu-phuong-func/Bai1.php">Exercise 1</a> </li>
                        ...
                        <div class="exercise-group w100">
                            <p class="exercise-title">KẾT HỢP PHP & MYSQL</p>
                            <ul class="exercise-item">
                                <li> <a href="./bai-tap/le-thi-thu-phuong-mysql/cau2_1.php">Exercise 1</a> </li>
                                <li> <a href="./bai-tap/le-thi-thu-phuong-mysql/cau2_2.php">Exercise 2</a> </li>
                                <li> <a href="./bai-tap/le-thi-thu-phuong-mysql/cau2_3.php">Exercise 3</a> </li>
                ...
                <div class="info-item">
                    ...
                    <div class="exercise-list">
                        <div class="exercise-group w100">
                            <p class="exercise-title">PHP & FORM</p>
                            <ul class="exercise-item ">
                                <li> <a href="bai-tap/nguyen-mai-thi-form/DT_hinhCN.php">Exercise 1</a> </li>
                                <li> <a href="bai-tap/nguyen-mai-thi-form/DT_HinhTron.php">Exercise 2</a> </li>
                                <li> <a href="bai-tap/nguyen-mai-thi-form/thanhtoanTienDien.php">Exercise 3</a> </li>
                        ...
                        <div class="exercise-group w100">
                            <p class="exercise-title">MẢNG, CHUỖI & HÀM</p>
                            <ul class="exercise-item">
                                <li> <a href="bai-tap/nguyen-mai-thi-func/baitap1.php">Exercise 1</a> </li>
                                <li> <a href="bai-tap/nguyen-mai-thi-func/baitap2.php">Exercise 2</a> </li>
                                <li> <a href="bai-tap/nguyen-mai-thi-func/bai3.php">Exercise 3</a> </li>
                        ...
                        <div class="exercise-group w100">
                            <p class="exercise-title">KẾT HỢP PHP & MYSQL</p>
                            <ul class="exercise-item">
                                <li> <a href="./bai-tap/nguyen-mai-thi-mysql/bt2.1.php">Exercise 1</a> </li>
                                <li> <a href="./bai-tap/nguyen-mai-thi-mysql/bt2.2.php">Exercise 2</a> </li>
                                <li> <a href="./bai-tap/nguyen-mai-thi-mysql/bt2.3.php">Exercise 3</a> </li>
                                <li> <a href="./bai-tap/nguyen-mai-thi-mysql/bt2.4.php">Exercise 4</a> </li>
                                <li> <a href="./bai-tap/nguyen-mai-thi-mysql/bt2.5.php">Exercise 5</a> </li>
                                <li> <a href="./bai-tap/nguyen-mai-thi-mysql/bt2.6.php">Exercise 6</a> </li>
                                <li> <a href="./bai-tap/nguyen-mai-thi-mysql/bt2.7.php">Exercise 7</a> </li>
                            </ul>
                            </ul>
                        </div>
                    </div>
