                ...
                <div class="admin-product--detail" style="margin-top: 20px; border: none;">
                    <div class="product-detail--content">
                        <div class="product-detail--id">
                            <span style="color: #1d48ba; font-weight: bold">Mã liên hệ:</span> <span class="product--id">'.$resultDetail['ma_lienhe'].'</span></div>
                        <div class="product-detail--name">
                            <span style="color: #1d48ba; font-weight: bold">Họ tên: </span>'.$resultDetail['ho_ten'].'</div>
                        <div class="product-detail--price">
                            <span style="color: #1d48ba; font-weight: bold">Email: </span> 
                            <span>'.$resultDetail['email'].'</span>
                        </div>
                        <div class="product-detail--type">
                            <span style="color: #1d48ba; font-weight: bold">Số điện thoại: </span>'.$resultDetail['so_dt'].'</div>
                        <div class="product-detail--desc">
                            <span style="color: #1d48ba; font-weight: bold">Nội dung: </span>'.$resultDetail['noi_dung'].'</div>
                    </div>
                </div>
            </div>
                ';
