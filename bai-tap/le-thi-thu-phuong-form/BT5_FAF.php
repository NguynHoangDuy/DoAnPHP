...
<body>
    ...
    <table align="center" bgcolor="#faebd7">
        <tr  style="background-color: #339A95;">
            <td colspan="2" align="center"><h3>TÍNH TIỀN KARAOKE</h3></td>
        </tr>
            <tr>
                <td>Giờ bắt đầu:</td>
                <td><input type="test" required value="<?php if (isset($start)) 
                        echo $start; else echo"";?>" name="start"></td>
            </tr>
            <tr>
                <td>Giờ kết thúc:</td>
                <td><input type="text" value="<?php if (isset($end))
                         echo $end; else echo"";?>" name="end"></td>
            </tr>
            <tr>
                <td>Tiền thanh toán:</td>
                <td><input type="text" value="<?php if (isset($kq))
                         echo $kq; else echo "";?> " name="result" disabled style="background-color: lightpink;"></td>
            </tr>
            <tr>
