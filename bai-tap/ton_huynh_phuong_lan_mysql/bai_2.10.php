    ...
    <?php
        if (isset($_GET["submit"])){
            ...
            <td style='border: 1px solid black' colspan='2' align='center' style='font-size: 20px'>".$rows['Ten_sua']." - ".$rows['Ten_hang_sua']."</td>
                ...
                echo "<td style='border: 1px solid black' style='border: 1px solid black'> <img src='./img/".$rows["Hinh"]."' style='display: block; margin: 0 auto;'</td>";
                echo "<td style='border: 1px solid black' style='border: 1px solid black' align='left'>";
            ...
            echo "</tr>";
                        ...
                        echo "<td style='border: 1px solid black' align='center' style='border:none'>
